...
(function () {
    ...
    // ---------- CSRF ----------
    // Las peticiones que cambian estado tienen que repetir el token de la cookie.
    // Los formularios lo llevan en un campo oculto; fetch(), en esta cabecera.
    window.csrfHeader = function (extra) {
        const meta = document.querySelector('meta[name="csrf-token"]');
        return Object.assign({ "X-CSRF-Token": meta ? meta.content : "" }, extra || {});
    };
    ...
    // ---------- Modo privacidad (solo apps con #btn-privacy en la topbar) ----------
